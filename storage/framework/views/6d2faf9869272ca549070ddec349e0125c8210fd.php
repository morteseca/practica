...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="surname" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Отчество')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="patronymic" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Фамилия')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Адрес электронной почты')); ?></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="rules" id="rules" <?php echo e(old('rules') ? 'checked' : ''); ?>>

                                    <label class="form-check-label" for="rules">
                                        <?php echo e(__('Согласие с правилами регистрации')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/users/dbcsbhcc/vvfjnzd-m1/resources/views/auth/register.blade.php ENDPATH**/ ?>